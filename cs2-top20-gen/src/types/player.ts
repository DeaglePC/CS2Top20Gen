...
export const defaultPlayerData: PlayerData = {
  ...
  photoUrl: "",
  teamLogoUrl: "",
  mvpAwards: [{ type: "MVP", event: "PGL Cluj-Napoca" }],
  evpAwards: [
    { type: "EVP", event: "PGL Bucharest" },
    { type: "EVP", event: "FISSURE Playground 2" },
  ],
  teamAchievements: [
    { place: "1ST", events: ["PGL Bucharest"] },
    {
      place: "2ND",
      events: [
        "PGL Cluj-Napoca",
  ...
  personalStats: [
    { name: "KPR", value: 0.72 },
    { name: "SURVIVING", value: 35.1 },
    { name: "ADR", value: 81.0 },
    { name: "MULTI-KILLS", value: 17.8 },
    { name: "KAST", value: 73.1 },
    { name: "ROUND SWING", value: 0.81 },
    { name: "RATING", value: 1.13 },
  ],
  notableStats: [
    { description: "1.13 rating 3.0", ranking: "#15" },
    { description: "81.0 damage per round", ranking: "#10" },
    { description: "0.13 opening kills per round", ranking: "#15" },
    { description: "17.8% rounds with 2+ kills", ranking: "#17" },
    { description: "1.10 Elite+ rating", ranking: "#14" },
    { description: "1.06 rating vs top 5", ranking: "#19" },
    { description: "1.08 playoff rating", ranking: "#17" },
    { description: "23.7% maps above 1.45 rating", ranking: "#11" },
    { description: "0.13 pistol kills per round", ranking: "#15" },
    { description: "1.17 rating on Train", ranking: "#15" },
    { description: "1.14 rating on Nuke", ranking: "#14" },
    { description: "0.72 kills per round", ranking: "#16" },
    { description: "1.21 impact rating", ranking: "#10" },
    { description: "60 clutches", ranking: "#18" },
    { description: "1.13 CT rating", ranking: "#14" },
    { description: "1.13 Big Event rating", ranking: "#12" },
    { description: "1.08 rating vs top 10", ranking: "#19" },
    { description: "1.09 rating in arenas", ranking: "#12" },
    { description: "6.68 grenade damage per round", ranking: "#13" },
    { description: "0.58 rifle kills per round", ranking: "#5" },
    { description: "1.16 rating on Dust2", ranking: "#18" },
  ],
};
